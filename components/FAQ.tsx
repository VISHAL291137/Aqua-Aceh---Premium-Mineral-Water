...
const FAQItem: React.FC<{ number: string, question: string, defaultOpen?: boolean }> = ({ number, question, defaultOpen = false }) => {
  ...
  return (
    <div className="border-b border-gray-100 last:border-0">
      ...
      {isOpen && (
        <div className="pb-6 pl-12 text-sm text-gray-500 leading-relaxed font-light">
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-20">
          <div>
            ...
            <h2 className="text-4xl font-serif mb-8 leading-tight">Hydration Questions</h2>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-8 flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-gray-100">
              <div className="flex-1 py-4 md:py-0 md:pr-8 flex items-center space-x-4">
                <div className="bg-blue-50 p-3 rounded-full text-blue-600">
                  <Truck size={20} />
                </div>
                <div>
                  <p className="text-[10px] uppercase tracking-widest text-gray-400 font-bold">Delivery Status</p>
                  <p className="text-blue-900 font-serif font-semibold">Track your delivery</p>
                </div>
              </div>
              <div className="flex-1 py-4 md:py-0 md:pl-8 flex items-center space-x-4">
                <div className="bg-blue-50 p-3 rounded-full text-blue-600">
                  <Info size={20} />
                </div>
                <div>
                  <p className="text-[10px] uppercase tracking-widest text-gray-400 font-bold">Quality Report</p>
                  <p className="text-blue-900 font-serif font-semibold">View Lab Results</p>
                </div>
              </div>
            </div>
          </div>
